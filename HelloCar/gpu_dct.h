...
class GpuDct {
    ...
    unsigned long long int dct(const cv::Mat &img) {
        ...
        unsigned long long int *d_hash_val; cudaMalloc(&d_hash_val, sizeof(unsigned long long int));
    ...
    void dct(const float *d_img, unsigned long long int *d_hash_val) {
        unsigned long long int *d_hash; cudaMalloc(&d_hash, sizeof(unsigned long long int));
    ...
    static void getDCTMatrix(const int rows,const int cols, float *d_Transfrom) {
